...
Bub_Main:	; Routine 0
		...
		move.w	#vramBubblesBGZ+$8000,obGfx(a0)
		cmpi.b	#id_BGZ,(v_zone).w
		beq.s	@notBGZ
		move.w	#vramBubblesMHZ+$8000,obGfx(a0)
...
Bub_BblMaker:	; Routine $A
		...
		tst.b	obRender(a0)
		bpl.w	@chkdel
		move.l	#Map_BubGen,obMap(a0)	; attempt to split generator and bubbles
		move.w	#$8000+vramBubbleGen,obGfx(a0)	; ^
		subq.w	#1,$38(a0)
		bpl.w	@loc_12914
		move.w	#1,$36(a0)
...
@loc_1287C:
		...
		move.l	#Map_Bub,obMap(a1)	; attempt to split generator and bubbles
		move.w	#$8000+vramBubblesBGZ,obGfx(a1)	; ^
