...
;	@notJump:
		...
		bset	#0,obStatus(a0)
		subq.w	#8,BKyu_Inertia(a0)
		cmpi.w	#-$600,BKyu_Inertia(a0)
		bgt.s	BKyuko_CollisionAndVelocity
		move.w	#-$600,BKyu_Inertia(a0)
		bra.s	BKyuko_CollisionAndVelocity
	@notLeft:
		...
		cmpi.w	#$600,BKyu_Inertia(a0)
		blt.s	BKyuko_CollisionAndVelocity
		move.w	#$600,BKyu_Inertia(a0)
		bra.s	BKyuko_CollisionAndVelocity
	@notRight:
		btst	#0,obStatus(a0)
		bne.s	@facingleft_movingright
	;@facingright_movingleft:
		subq.w	#8,BKyu_Inertia(a0)
		bmi.s	@setToZero
		bra.s	BKyuko_CollisionAndVelocity
	@facingleft_movingright:
		addq.w	#8,BKyu_Inertia(a0)
		bpl.s	@setToZero
		bra.s	BKyuko_CollisionAndVelocity
	@setToZero:
