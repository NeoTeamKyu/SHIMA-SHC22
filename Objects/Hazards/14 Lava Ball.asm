...
LBall_Main:	; Routine 0
		...
		move.w	#vramFireMHZ,obGfx(a0)
		cmpi.b	#id_MZ,(v_zone).w	; Check if level is ATZ
		bne.s	@notATZ
		move.w	#$345,obGfx(a0)
		bra.s	@notSLZ
	...
	@notSLZ:
		...
		;bset	#1,obShieldDeflect(a0)		
		move.w	obY(a0),$30(a0)
		tst.b	$29(a0)
		beq.s	@speed
		addq.b	#1,obPriority(a0)	; same thing as adding $100, since we're adding to the high byte.
