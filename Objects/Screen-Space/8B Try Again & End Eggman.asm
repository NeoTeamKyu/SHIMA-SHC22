...
EEgg_Main:	; Routine 0
		...
		move.b	#id_EndEggman,(v_banner).w ; load credits object, which is now just this since it's literally never used outside of this
		move.b	#1,(v_banner+obSubtype).w
		move.b	#id_TryChaos,(v_lvlobjspace).w ; load emeralds object on "TRY AGAIN" screen
...
EEgg_Juggle:	; Routine 4
	...
	@noflip:
		lea	(v_lvlobjspace).w,a1 ; get RAM address for emeralds
		moveq	#5,d1
...
EEgg_TryText:
		...
		move.l	#Map_EEgg,obMap(a0)
		move.w	#$3E1,obGfx(a0)
		move.b	#8,obFrame(a0)	; display appropriate sprite
		move.b	#0,obRender(a0)
