...
CSon_Main:	; Routine 0
	...
	; Check for continue gamemode
		cmpi.b	#id_Continue,(v_gamemode).w
		beq.s	CSon_NotOptionsMenu
		move.w	#$30,obX(a0)
...
LoadFollowObjects:
		...
		move.b	@followObjLUT(pc,d0.w),(v_followobject).w
		move.w	a0,(v_followobject+parent).w ; set its parent object to this
	@done:
		rts
	
	@followObjLUT:
		dc.b	id_Abbey, id_TailsTails, 0, 0, 0, 0, 0, 0