...
ESon_MakeEmeralds:
		...
		addq.b	#2,ob2ndRout(a0)
		move.w	#1,obAnim(a0)
		move.b	#id_EndChaos,(v_oemeralds).w ; load chaos emeralds objects
...
Obj87_LookUp:	; Routine 6
		cmpi.w	#$2000,((v_oemeralds&$FFFFFF)+$3C).l
		bne.s	locret_5480
...
Obj87_MakeLogo:	; Routine $C
		...
		move.b	#2,obAnim(a0)
		move.b	#id_EndSTH,(v_oemeralds).w ; load "SONIC THE HEDGEHOG" object
