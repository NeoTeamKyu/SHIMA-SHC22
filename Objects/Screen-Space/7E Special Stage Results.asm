...
loc_C86C:
		...
		move.b	#$81,(f_lockmulti).w ; lock controls & position to prevent weird deaths!
		addq.b	#2,obRoutine(a0)
		move.w	#290,obTimeFrame(a0) ; set time delay to 3 seconds
		move.b	#id_SSRChaos,(v_lvlobjspace).w ; load chaos emerald object
...
SSR_Continue:	; Routine $E
		move.b	#4,(v_lvlobjspace+obFrame).w
		move.b	#$14,(v_lvlobjspace+obRoutine).w
