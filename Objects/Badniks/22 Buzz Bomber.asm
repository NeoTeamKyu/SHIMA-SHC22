...
; ===========================================================================
	...
	@fire:
		...
		addi.w	#$16,obY(a1)	; Changed from $1C.
		subi.w	#16,obX(a1)		; Added, to make it come out *at* the cannon. This gets subtracted twice if it's facing the other way.
		...
		addi.w	#32,obX(a1)	; Subtract twice the aforementioned X position.
