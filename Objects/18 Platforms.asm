...
Plat_Main:	; Routine 0
		...
		cmpi.b	#3,(v_act).w ; check if level is LBGZ
		bne.s	@notLegacy
		move.l	#Map_Plat_LBGZ,obMap(a0) ; LBGZ specific code
		move.w	#$4000+vramPlatLBGZ,obGfx(a0)
	...
	@notSLZ:
		...
		move.w	obY(a0),$2C(a0)
		move.w	obY(a0),PlatformYpost(a0)
		move.w	obX(a0),$32(a0)
...
@type03:
		...
		tst.b	$38(a0)	; is Sonic standing on the platform?
...
Plat_ChkDel:
		out_of_range_resp.s	Plat_Delete,$32(a0)
		rts
; ===========================================================================
