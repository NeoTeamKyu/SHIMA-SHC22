...
FBlock_Main:	; Routine 0
		...
		bne.s	@notGHZ
		move.w	#$4331,obGfx(a0)
		move.l	#Map_FBlockGHZ,obMap(a0)
	@notGHZ:
	...
	@notLZ:
		...
		cmpi.w	#$1BB8,obX(a0)
		bne.s	@notatpos
		tst.b	(v_floatingblockunknown).w
		beq.s	@dontdelete
		jmp	(DeleteObject).l
	@notatpos:
		clr.b	obSubtype(a0)
...
FBlock_Action:	; Routine 2
	...
	@chkdel:
		out_of_range_resp.s	@chkdel2,fb_origX(a0)
	@display:
		bra.w	DisplaySprite
	@chkdel2:
		cmpi.b	#$37,obSubtype(a0)
...
@loc_1055E:
		...
		bne.s	@locret_10578
		move.b	#1,(v_floatingblockunknown).w
		clr.b	$38(a0)
		clr.b	obSubtype(a0)
