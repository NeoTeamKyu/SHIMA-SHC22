...
HUD_Update:
	...
	@chktime:
		...
		bcc.w	TimeOver	; if yes, branch	;Mercury HUD In Special Stage (bsr.s => bsr.w)
...
; ===========================================================================
Hud_TilesBase:	dc.b $B, $FF, $FF, $FF, $FF, $FF, $FF,	0, 0, $A, 0, 0, $C, 0, 0
