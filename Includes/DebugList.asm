...
;			mappings		object	subtype	frame VRAM setting
	dbug 	Map_Ring,		id_Rings,	0,	0,	$2000+vramRing
	dbug	Map_Monitor,	id_Monitor,	0,	0,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	1,	3,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	2,	4,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	3,	5,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	4,	6,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	5,	7,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	6,	8,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	7,	9,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	8,	$A,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	9,	$B,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$A,	$C,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$B,	$D,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$C,	$E,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$D,	$F,	vramMonitors
	dbug	Map_Spike,		id_Spikes,	0,	0,	$6000+vramSpikesBGZ
	dbug	Map_Spike,		id_Spikes,	$10,	1,	$6000+vramSpikesBGZ
	dbug	Map_Spring,		id_Springs,	0,	0,	vramSpringBGZ
	dbug	Map_Lamp,		id_Lamppost,	1,	0,	vramLamp
	dbug	Map_Plat_GHZ,	id_BasicPlatform, 0,	0,	$4000+vramBlockBGZ
	dbug	Map_SmabBGZ,	id_SmashBlock,	0,	0,	$4000+vramBlockBGZ
	dbug	Map_SmabBGZ,	id_SmashBlock,	1,	1,	$4000+vramBlockBGZ
	dbug	Map_SmabBGZ,	id_SmashBlock,	2,	2,	$4000+vramBlockBGZ
	dbug	MapSpr_SpringBoard,id_BambooSpringboard, 0, 0, vramSprBrdBGZ
	dbug	Map_FlowerCannon, id_FlowerCannon, 0, 0, vramCannonBGZ
	dbug	Map_FlapdoorH, id_CDFlapdoor, 0, 0, vramFlapBGZ
	dbug	Map_FlapdoorV, id_CDFlapdoor, 1, 0, vramFlapBGZ
	dbug	Map_Moto,		id_MotoBug,	0,	0,	vramMotobugBGZ
	dbug	Map_WindUpKoi,	id_WindUpKoi,0,	0,	vramKoiBGZ
	dbug	Map_Mosqui,		id_Mosqui,	0,	0,	vramMosquiBGZ
	dbug	Map_BGZSeaweed,	id_Scenery,	4,	0,	vramSeaweedBGZ
	dbug	Map_BGZShoji,	id_Scenery,	6,	0,	$4000+vramBlockBGZ
	dbug	Map_BGZStatues,	id_PurpleRock,	0,	0,	vramStatueBGZ
	dbug	Map_Kyuko,		id_BossBGZ,	0,	1,	$4400
	@BGZend:
	; removed hidden points and giant ring: don't need them, especially not in the debug list, and they're boring anyway.
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Monitor,	id_Monitor,	$C,	$E,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$D,	$F,	vramMonitors
	dbug	Map_Spike,		id_Spikes,	0,	0,	vramSpikesBGZ
	dbug	Map_Spike,		id_Spikes,	$10,	1,	vramSpikesBGZ
	dbug	Map_Spring,		id_Springs,	0,	0,	vramSpringBGZ
	dbug	Map_Lamp,		id_Lamppost,	1,	0,	vramLamp
	...
	dbug 	Map_Eggman,	id_BossLabyrinth,	$4,	0,	$27B2
	@LZend:
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_SmabMTZ,	id_SmashBlock,	0,	0,	$42B8
...
;		mappings	object		subtype	frame	VRAM setting
        dbug	Map_Snowrex,	id_Snowrex,	1,	0,	vramSnowrexMHZ
	dbug 	Map_Ring,		id_Rings,	0,	0,	$2000+vramRing
	dbug	Map_Monitor,	id_Monitor,	0,	0,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	1,	3,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	2,	4,	vramMonitors
	...
	dbug	Map_Monitor,	id_Monitor,	$C,	$E,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$D,	$F,	vramMonitors
	dbug	Map_Spike,		id_Spikes,	0,	0,	$4000+vramSpikesBGZ
	dbug	Map_Spike,		id_Spikes,	$10,	1,	$4000+vramSpikesBGZ
	dbug	Map_Spring,		id_Springs,	0,	0,	vramSpringBGZ
	dbug	Map_Lamp,		id_Lamppost,	1,	0,	vramLamp
	dbug	Map_Snowrex,	id_Snowrex,	0,	0,	vramSnowrexMHZ
	dbug	Map_SnowTulipon,id_SnowTulipon, 0,  0,  vramTuliponMHZ
;	dbug 	Map_Dango,		id_Dango,	0,	0,	$4B8
	@MHZend:
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Monitor,	id_Monitor,	$C,	$E,	vramMonitors
	dbug	Map_Monitor,	id_Monitor,	$D,	$F,	vramMonitors
	dbug	Map_Crab,		id_Crabmeat,	  0,	0,	vramCrabmeatLBGZ
	dbug	Map_Buzz,		id_BuzzBomber,	  0,	0,	vramBuzzLBGZ
	dbug	Map_Chop,		id_WindUpKoi,	  0,	0,	vramChopperLBGZ
	dbug	Map_Spike,		id_Spikes,		  0,	0,	vramSpikesBGZ
	dbug	Map_Spike,		id_Spikes,	$10,	1,	vramSpikesBGZ
	dbug	Map_Plat_LBGZ,	id_BasicPlatform, 0,	0,	$4000+vramPlatLBGZ
	dbug	Map_LRock,		id_PurpleRock,	  0,	0,	$4000+vramRockLBGZ
	dbug	Map_Moto,		id_MotoBug,		  0,	0,	vramMotobugLBGZ
	dbug	Map_Spring,		id_Springs,		  0,	0,	vramSpringBGZ
	dbug	Map_Newt,		id_Newtron,		  0,	1,	vramNewtronLBGZ
	dbug	Map_Newt,		id_Newtron,		  1,	1,	$2000+vramNewtronLBGZ
;	dbug	Map_Edge,		id_EdgeWalls,	  0,	0,	$434C
	dbug	Map_GBall,		id_RollingBall,	  0,	0,	$4000+vramBallLBGZ	; fuck you
	dbug	Map_Lamp,		id_Lamppost,	  1,	0,	vramLamp
