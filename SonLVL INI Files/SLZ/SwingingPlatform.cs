	...
	class SwingingPlatform : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../art/nemesis/SLZ Swinging Platform.bin", CompressionType.Nemesis), "../Mappings/Swinging Platforms (SLZ).asm", labels[i], i == 1 ? 0 : 2));
		}
