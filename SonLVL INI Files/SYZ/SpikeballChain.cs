...
namespace S1ObjectDefinitions.SYZ
{
	class SpikeballChain : ObjectDefinition
	{
		...
		{
			img = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../art/nemesis/SYZ Small Spikeball.bin", CompressionType.Nemesis), "../Mappings/Spiked Ball and Chain (SYZ).asm", 0, 0);
		}
